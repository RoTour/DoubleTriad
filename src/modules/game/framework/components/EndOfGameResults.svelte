...
<div class="fixed top-0 left-0 h-screen w-screen bg-semi-transparent z-10 flex items-center">
	<div
		class="min-h-[30%] w-screen bg-amber-400 border-y-8 border-amber-200 z-20 flex flex-col py-12"
	>
		...
		<button
			on:click={newGame}
			class="mt-8 px-8 py-4 bg-amber-800 w-fit m-auto rounded-md font-bold text-amber-200"
			>CONTINUE</button
		>
	</div>
</div>
